...
KA1=P0(106);         %Intensifying rate in kf6p by ATM_ATR  1
KP=P0(107);          %Intensifying  rate in of kf11p by pttg1  1
KA2=P0(108);         %Intensifying  rate in ks8 by ATM_ATR  1
Kp53=P0(109);        %Reduction rate of ks5 for returning to normal
KDDS=P0(110);        %Reduction rate of ks27 for returning to normal  
KA3=P0(111);         %Reduction rate of ks28 for returning to normal
KMCD=P0(112);        %Reduction rate of Mad2_Cdc20P dissociation by p21 
...
dp21=ks5*(Kp53+p53)+kf5*p21_MPF-kr5*MPF*p21^N1-kd5*p21^N1;
...
dCdc20P=kr9*Cdc20-kf18*Mad2*Cdc20P+kr18*Mad2_Cdc20P*(KMCD+p21+Epsilon*Plk1P)-kf9*Cdc20P/(KCdc20P1+Cdc20P)+kr9*APCP_Cdc20-kd18p1*Cdc20P-kd18p3*(APC_Cdh1+APCP_Cdh1)/(KCdc20P2+Cdc20P)*Cdc20P;
if Mad2_Cdc20P > ASP   
    dCdc20=0;
    dCdc20P=0;
end
...
dATM_ATR=ks27*(KDDS+sig) -kd27p*ATM_ATR*Wip1^N2/(KWip1^N2+Wip1^N2)- kd27*ATM_ATR;
dp53= ks28*(KA3 + ATM_ATR)-kf16*p53+ kr16*p53P-kd28p*p53*Mdm2-kd28*p53;  
...
dMad2=ks33-kf18*Mad2*Cdc20P+kr18*Mad2_Cdc20P*(KMCD+p21+ Epsilon*Plk1P)-kd33*Mad2;
dMad2_Cdc20P= kf18*Mad2*Cdc20P-kr18*Mad2_Cdc20P*(KMCD+p21+ Epsilon*Plk1P);
