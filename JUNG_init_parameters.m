...
P0(27)=0.02;     %Dephosphorylation rate constant of Cdh1P by PP2A  0.01 
...
P0(43)=0.1;      %Backward rate constant for dissociation of MAD2_Cdc25P 10

P0(44)=0.1;      %Cyclin synthesis rate constant  %0.1
P0(45)=0.0001;   %p21 synthesis rate constant influence
...
P0(54)=0.0001;   %ATM_ATR synthesis rate constant  
P0(55)=0.0001;   %p53 synthesis rate constant
P0(56)=0.0001;   %Mdm2 synthesis rate constant  
P0(57)=6;        %p53P-dependent Mdm2 synthesis rate constant
P0(58)=0.0001;   %Wip1 synthesis rate constant
P0(59)=6;        %p53P-dependent Wip1 synthesis rate constant  
...
P0(70)=0.01;        %p21 self-degradation rate constant %0.1 Need to check 
...
P0(106)=1;        % Amplication rate in kf6p by ATM_ATR  
P0(107)=0.5;      % Amplication rate in of kf11p by pttg1  
P0(108)=1;        % Amplication rate in ks8 by ATM_ATR  
P0(109)=0.001;    % Amplication factor of ks5 by p53
P0(110)=1000;    % Amplication factor of ks27 by DDS  
P0(111)=0.0002;   % Amplication factor of ks28 by by ATM_ATR
P0(112)=0.01;     % Amplication rate of Mad2_Cdc20P dissociation by p21  
P0(113)=1;        % Ratio of Plk1:p21 
