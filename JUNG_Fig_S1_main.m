...
nos=[3 7 9 19 34 37 39 41 42 43 46 47];
for i=1:length(nos)
    legend_str{i}=concentration_str{nos(i)}; 
end

ks8_val=[0.07 0.08 0.1 0.5];
for no=1:length(ks8_val)
    P0(46)=ks8_val(no);  %Cdc25 synthesis rate
...
set(hL,'Position', [0.8 0.69 0.2 0.2],'Units', 'normalized');
